...
const siteContent = {
  ...
  work: [
    ...
    { category: "real-estate",     featured: true, title: { ar: "إعلان للبيع | تصوير ومونتاج", en: "Property Sale Advertisement | Filming & Video Editing" }, desc: { ar: "تصوير ومونتاج إعلان احترافي يبرز مميزات الارض الزراعية وجاهزيتها للإيجار.", en: "Professional promotional video showcasing the agricultural land and its lease-ready facilities." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/IF1wwGnmwlQ?feature=share" },
    { category: "real-estate",     featured: true, title: { ar: "إعلان للإيجار | تصوير ومونتاج", en: "Rental Ad | Filming & Editing" }, desc: { ar: "تصوير ومونتاج احترافي لإعلان عقاري يبرز مميزات العقار من خلال لقطات سينمائية وانتقالات سلسة ورسوم معلوماتية تعزز جاذبية العرض.", en: "Professional real estate commercial featuring cinematic filming, dynamic editing, and engaging motion graphics to highlight the property's key features." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/mGHxmE649JI?feature=share" },
    { category: "real-estate",     featured: true, title: { ar: "حوش للإيجار | تصوير ومونتاج", en: "Rental Ad | Filming & Editing" }, desc: { ar: "مونتاج إعلان احترافي لحوش للإيجار في مخطط الصقير على طريق الرياض–الخرج، يبرز الموقع والمساحة والمزايا من خلال لقطات ديناميكية وتصميم بصري جذاب.", en: "Professional promotional video editing for a yard available for lease in Al-Suqair Plan, Riyadh–Al Kharj Road, highlighting the location, space, and key features through dynamic visuals and engaging motion design." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/g1bq26aWNMo?feature=share" },
