    ...
    projects: [
      {
        ...
        gallery: [
        "url('images/Posts/1.webp') center center / cover no-repeat",
  "url('images/Posts/2.webp') center center / cover no-repeat",
  "url('images/Posts/3.webp') center center / cover no-repeat"
        ]
      },
      {
