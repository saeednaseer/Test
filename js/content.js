...
const siteContent = {
  ...
  work: [
    ...
    { category: "logo-animation",  featured: true, title: { ar: "تحريك شعار | أستديو مسهور (الإصدار الأول)", en: "Logo Animation | Mashhour Studio (Version 1)" }, desc: { ar: "تنفيذ موشن جرافيك لشعار أستديو مسهور بأسلوب احترافي يعكس هوية البرنامج ويمنحه حضورًا بصريًا مميزًا.", en: "Motion graphics for the Mashhour Studio logo, reflecting the program's identity with a distinctive visual presence." }, gradient: "linear-gradient(135deg,#7A1750,#0E0E10)", videoLink: "https://youtu.be/l5TJtVsIVoI" },
  ...
  clients: [
    { name: { ar: "عميل 01", en: "Client 01" }, logo: "images/clients/1.png" },
    { name: { ar: "عميل 02", en: "Client 02" }, logo: "images/clients/2.png" },
    { name: { ar: "عميل 03", en: "Client 03" }, logo: "images/clients/3.png" },
    { name: { ar: "عميل 04", en: "Client 04" }, logo: "images/clients/4.png" },
    { name: { ar: "عميل 05", en: "Client 05" }, logo: "images/clients/5.png" },
    { name: { ar: "عميل 06", en: "Client 06" }, logo: "images/clients/6.png" },
    { name: { ar: "عميل 07", en: "Client 07" }, logo: "images/clients/7.png" },
    { name: { ar: "عميل 08", en: "Client 08" }, logo: "images/clients/8.png" },
    { name: { ar: "عميل 09", en: "Client 09" }, logo: "images/clients/9.png" },
    { name: { ar: "عميل 10", en: "Client 10" }, logo: "images/clients/10.png" },
    { name: { ar: "عميل 11", en: "Client 11" }, logo: "images/clients/11.png" },
    { name: { ar: "عميل 12", en: "Client 12" }, logo: "images/clients/12.png" },
    { name: { ar: "عميل 13", en: "Client 13" }, logo: "images/clients/13.png" },
    { name: { ar: "عميل 14", en: "Client 14" }, logo: "images/clients/14.png" },
    { name: { ar: "عميل 15", en: "Client 15" }, logo: "images/clients/15.png" },
    { name: { ar: "عميل 16", en: "Client 16" }, logo: "images/clients/16.png" },
    { name: { ar: "عميل 17", en: "Client 17" }, logo: "images/clients/17.png" },
    { name: { ar: "عميل 18", en: "Client 18" }, logo: "images/clients/18.png" },
    { name: { ar: "عميل 19", en: "Client 19" }, logo: "images/clients/19.png" },
    { name: { ar: "عميل 20", en: "Client 20" }, logo: "images/clients/20.png" },
    { name: { ar: "عميل 21", en: "Client 21" }, logo: "images/clients/21.png" },
    { name: { ar: "عميل 22", en: "Client 22" }, logo: "images/clients/22.png" },
    { name: { ar: "عميل 23", en: "Client 23" }, logo: "images/clients/23.png" },
    { name: { ar: "عميل 24", en: "Client 24" }, logo: "images/clients/24.png" },
    { name: { ar: "عميل 25", en: "Client 25" }, logo: "images/clients/25.png" },
    { name: { ar: "عميل 26", en: "Client 26" }, logo: "images/clients/26.png" },
    { name: { ar: "عميل 27", en: "Client 27" }, logo: "images/clients/27.png" },
    { name: { ar: "عميل 28", en: "Client 28" }, logo: "images/clients/28.png" },
    { name: { ar: "عميل 29", en: "Client 29" }, logo: "images/clients/29.png" },
    { name: { ar: "عميل 30", en: "Client 30" }, logo: "images/clients/30.png" },
    { name: { ar: "عميل 31", en: "Client 31" }, logo: "images/clients/31.png" },
    { name: { ar: "عميل 32", en: "Client 32" }, logo: "images/clients/32.png" },
    { name: { ar: "عميل 33", en: "Client 33" }, logo: "images/clients/33.png" },
    { name: { ar: "عميل 34", en: "Client 34" }, logo: "images/clients/34.png" },
    { name: { ar: "عميل 35", en: "Client 35" }, logo: "images/clients/35.png" }
  ],
