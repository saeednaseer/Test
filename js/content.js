...
const siteContent = {
  ...
  work: [
    ...
    { category: "real-estate",     featured: true, title: { ar: "جولة عقارية كاملة", en: "Full Property Tour" }, desc: { ar: "تغطية شاملة لوحدة سكنية من الداخل والخارج.", en: "Comprehensive coverage of a residential unit, inside and out." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtu.be/vWaPPHRjxgg" },
      { category: "real-estate",     featured: true, title: { ar: "جولة عقارية كاملة", en: "Full Property Tour" }, desc: { ar: "تغطية شاملة لوحدة سكنية من الداخل والخارج.", en: "Comprehensive coverage of a residential unit, inside and out." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/1S-Uw8Pdz_o" },
    ...
    { category: "real-estate",     featured: false, title: { ar: "إعلان للبيع | تصوير ومونتاج", en: "Property Sale Advertisement | Filming & Video Editing" }, desc: { ar: "تصوير ومونتاج إعلان احترافي يبرز مميزات الارض الزراعية وجاهزيتها للإيجار.", en: "Professional promotional video showcasing the agricultural land and its lease-ready facilities." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/IF1wwGnmwlQ?feature=share" },
    { category: "real-estate",     featured: false, title: { ar: "إعلان للإيجار | تصوير ومونتاج", en: "Rental Ad | Filming & Editing" }, desc: { ar: "تصوير ومونتاج احترافي لإعلان عقاري يبرز مميزات العقار من خلال لقطات سينمائية وانتقالات سلسة ورسوم معلوماتية تعزز جاذبية العرض.", en: "Professional real estate commercial featuring cinematic filming, dynamic editing, and engaging motion graphics to highlight the property's key features." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/mGHxmE649JI?feature=share" },
    { category: "real-estate",     featured: false, title: { ar: "حوش للإيجار | تصوير ومونتاج", en: "Rental Ad | Filming & Editing" }, desc: { ar: "مونتاج إعلان احترافي لحوش للإيجار في مخطط الصقير على طريق الرياض–الخرج، يبرز الموقع والمساحة والمزايا من خلال لقطات ديناميكية وتصميم بصري جذاب.", en: "Professional promotional video editing for a yard available for lease in Al-Suqair Plan, Riyadh–Al Kharj Road, highlighting the location, space, and key features through dynamic visuals and engaging motion design." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/g1bq26aWNMo?feature=share" },
    { category: "real-estate",     featured: true, title: { ar: "مونتاج مجمع طبي للإيجار.", en: "Medical Complex for Lease | Video Editing" }, desc: { ar: "مونتاج إعلان لمجمع طبي للإيجار.", en: "Promotional video editing for a medical complex available for lease." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtu.be/7_T6caRFbJ0" },
      { category: "real-estate", featured: false, title: { ar: "تغطية مستودعات حي الندوة", en: "Al Nadwah Warehouses | Video Coverage" }, desc: { ar: "تصوير ومونتاج احترافي لتغطية مستودعات بحي الندوة في الرياض.", en: "Professional filming and editing showcasing warehouses in Al Nadwah, Riyadh." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/sZcsJ4pKjRc" },
{ category: "real-estate", featured: true, title: { ar: "مونتاج عمارة سكنية للإيجار", en: "Residential Building for Lease | Video Editing" }, desc: { ar: "إنتاج فيديو إعلاني لعمارة سكنية متاحة للإيجار في الرياض.", en: "Promotional video editing for a residential building available for lease in Riyadh." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/gnHN9xy3mVw" },
{ category: "real-estate", featured: false, title: { ar: "مونتاج 3D لمحطة وقود", en: "3D Gas Station Visualization" }, desc: { ar: "إنتاج مونتاج ثلاثي الأبعاد لمحطة وقود في البوابة الصناعية بالرياض.", en: "3D promotional visualization for a gas station project in Riyadh Industrial Gate." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/OXGulA9DVA4" },
{ category: "motion", featured: true, false: { ar: "موشن جرافيك لإعلان عقاري", en: "Real Estate Motion Graphics" }, desc: { ar: "تصميم وتحريك إعلان عقاري باستخدام تقنيات الموشن جرافيك.", en: "Motion graphics project created for a real estate promotional campaign." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/DGFN1zQRTMA" },
{ category: "real-estate", featured: false, title: { ar: "مشروع مستودعات باتك العقارية", en: "Batek Real Estate Warehouses" }, desc: { ar: "مونتاج إعلاني لمشروع مستودعات تابع لشركة باتك العقارية.", en: "Promotional video editing for the Batek Real Estate warehouse project." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/85VVQ_antb8" },  
{ category: "real-estate", featured: false, title: { ar: "مستودع للبيع أو للإيجار", en: "Warehouse for Sale or Lease" }, desc: { ar: "إنتاج فيديو إعلاني لتسويق مستودع للبيع أو للإيجار في البوابة الصناعية بالرياض.", en: "Promotional video for a warehouse available for sale or lease in Riyadh Industrial Gate." }, gradient: "linear-gradient(135deg,#7A1F4F,#0E0E10)", videoLink: "https://youtube.com/shorts/G5lDwcGVAT0" },
